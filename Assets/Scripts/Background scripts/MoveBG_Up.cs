...
public class MoveBG_Up : MonoBehaviour {
    ...
    void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if (col.tag == "BackgroundTileTop")
        {
            ...
            Vector3 pos = col.transform.position;
            pos.y += (heightOfBgObject * numBgPanels);
            R3C1.transform.position = new Vector3(R3C1.transform.position.x, pos.y, R3C1.transform.position.y);
            R3C2.transform.position = new Vector3(R3C2.transform.position.x, pos.y, R3C2.transform.position.y);
            R3C3.transform.position = new Vector3(R3C3.transform.position.x, pos.y, R3C3.transform.position.y);
            R3C4.transform.position = new Vector3(R3C4.transform.position.x, pos.y, R3C4.transform.position.y);
        }
    }
}
